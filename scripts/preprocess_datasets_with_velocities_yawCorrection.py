...
workingDirectory = '/home/majd/catkin_ws/src/basic_rl_agent/data2/flightgoggles/datasets/imageBezierDataV2_1000_images_skip_half' # provide the data subfolder in the dataset root directory.
