...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, GlobalAveragePooling2D, add
from tensorflow.keras import regularizers


def resnet8(img_input, output_dim, f=0.25):
    """
    ...
    x7 = add([x5, x6], name="conv_layer_output")
